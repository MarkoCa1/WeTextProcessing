...
class Time(Processor):
    ...
    def build_tagger(self):
        h = string_file(get_abs_path("yue/data/time/hour.tsv"))
        m = string_file(get_abs_path("yue/data/time/minute.tsv"))
        s = string_file(get_abs_path("yue/data/time/second.tsv"))
        noon = string_file(get_abs_path("yue/data/time/noon.tsv"))
        colon = delete(":") | delete("：")
