...
from tn.yue.equation_div_slash import DIV_SLASH_SENTINEL
...
class PostProcessor(Processor):
    ...
    def __init__(self, remove_interjections=True, remove_puncts=False, full_to_half=True, tag_oov=False):
        ...
        blacklist = string_file(get_abs_path("yue/data/default/blacklist.tsv"))
        puncts = string_file(get_abs_path("yue/data/char/punctuations_zh.tsv"))
        full2half = string_file(get_abs_path("yue/data/char/fullwidth_to_halfwidth.tsv"))
        zh_charset_std = string_file(get_abs_path("yue/data/char/charset_national_standard_2013_8105.tsv"))
        zh_charset_ext = string_file(get_abs_path("yue/data/char/charset_extension.tsv"))
