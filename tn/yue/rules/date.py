...
class Date(Processor):
    ...
    def build_tagger(self):
        digit = string_file(get_abs_path("yue/data/number/digit.tsv"))
        zero = string_file(get_abs_path("yue/data/number/zero.tsv"))

        yyyy = digit + (digit | zero) ** 3
        m = string_file(get_abs_path("yue/data/date/m.tsv"))
        mm_src = string_file(get_abs_path("yue/data/date/mm.tsv"))
        d = string_file(get_abs_path("yue/data/date/d.tsv"))
        dd_src = string_file(get_abs_path("yue/data/date/dd.tsv"))
