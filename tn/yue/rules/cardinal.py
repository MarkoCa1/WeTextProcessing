...
from tn.yue.context_keywords import (
...
class Cardinal(Processor):
    ...
    def build_tagger(self):
        ...
        teen = string_file(get_abs_path("yue/data/number/teen.tsv"))
        sign = string_file(get_abs_path("yue/data/number/sign.tsv"))
        dot = string_file(get_abs_path("yue/data/number/dot.tsv"))
